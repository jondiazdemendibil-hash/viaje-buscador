                ...
                <div class="carousel-column">
                    ...
                    <section class="carousel-3d-section" aria-label="<?php echo esc_attr__('Recomendaciones', 'vw'); ?>">
                        <div class="carousel-3d">
                            <button class="carousel-nav-btn carousel-prev" type="button" aria-label="<?php echo esc_attr__('Anterior', 'vw'); ?>">‹</button>
                            <button class="carousel-nav-btn carousel-next" type="button" aria-label="<?php echo esc_attr__('Siguiente', 'vw'); ?>">›</button>
